...
public class Lesson_7 {
    ...
    private static void start(Class testClass) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        Object checkTestClass = testClass.newInstance();
        Method[] methods = testClass.getDeclaredMethods();
        ArrayList<Method> al = new ArrayList<>();
        Method beforeMethod = null;
        Method afterMethod = null;

        //Составление списка методов (аннотаций) и проверка на лишние BeforeSuite и AfterSuite
        ...
        //Вызов методов (аннотаций)
        if (beforeMethod != null) beforeMethod.invoke(checkTestClass, null);
        for (Method o : al) o.invoke(checkTestClass, null);
        if (afterMethod != null) afterMethod.invoke(checkTestClass, null);
    }
}
