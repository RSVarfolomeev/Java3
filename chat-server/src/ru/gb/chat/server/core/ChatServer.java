    ...
    private void handleAuthMessage(ClientThread client, String msg) {
        ...
        switch (msgType) {
            case Common.CHANGE_NICKNAME:
                ...
                SqlClient.changeNickname(arr[1], login, password);
                sendToAllAuthorizedClients(
                        Common.getChangeNicknameBroadcast(client.getNickname(), arr[1]));
                client.authAccept(SqlClient.getNickname(login, password));
                break;
